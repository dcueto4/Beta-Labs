...
public class Main {
	...
	public static void main(String[] args) {
		...
		//String is imutable and cannot be changed thus it takes up more space in memory 
		//but a Stringbuider is mutable and can be changed thus taking less space in memory. 
		...
		Set<String> startsWithC = findAllThatStartWtih(set, 'C');
		...
		dictionary.put("Watermelon", "the large melonlike fruit of a plant of the gourd family, with smooth green skin, red pulp, and watery juice.");
		dictionary.put("Mango", "a fleshy yellowish-red tropical fruit that is eaten ripe or used green for pickles or chutneys.");
		dictionary.put("Cantaloupe", "a small round melon of a variety with orange flesh and ribbed skin.");
		...
		String value = lookupValue(dictionary, "Mango");
	...
	public static Set<String> findAllThatStartWtih(Set<String> set, char c) {
